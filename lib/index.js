...
var setIsolationLebel = function(connection,level){
...
Client.setAutoCommit = function(){
	var queryText = 'set autocommit';
...
Client.isolationLevel = function(level){
	...
	return setIsolationLebel(this.connection,level);
};

Client.setIsolationLebelSerializable = function(){
	return setIsolationLebel(this.connection,ISOLATIONLEVEL_SERIALIZABLE);
};

Client.setIsolationLebelRepeatableRead = function(){
	return setIsolationLebel(this.connection,ISOLATIONLEVEL_REPEATABLE_READ);
};

Client.setIsolationLebelReadCommited = function(){
	return setIsolationLebel(this.connection,ISOLATIONLEVEL_READ_COMMITED);
};
